...
"https://www.statology.org/remove-outliers-in-boxplots-r/"
```
...
"Because we use only one axis and then with that we create a bar with the amount of occurence, doesn't need the y-axis for bar. Use col if we want different y-axis"
```
...
"What it does is enable sectioning of the plot. Indicate from which area you want to see your data on x axis e.g. 10-50. then the third component is for density of data I would say how accurate you want to display the data. So if it's a large number it will be the color or data most represented that will be displayed but maybe there is a higher distribution if a smaller number is chosen"
```
